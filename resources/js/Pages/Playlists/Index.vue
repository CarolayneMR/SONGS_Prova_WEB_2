<script setup>
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout.vue'; //Importei o AutheticatedLayout para pegar a tela, caso contrario ela não mostrava as outras tela do Laravel.
